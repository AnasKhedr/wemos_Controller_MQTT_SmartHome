...
#include "interface/ImqttObserver.hpp"
#include "network/mqttClient.hpp"
#include "preferals/gas_sensor/gasSensor.hpp"
#include "preferals/motion_sensor/motionSensor.hpp"
...
private:
    ...
    //!
    template<typename T> void writeToEEPROM(int address, T xdata);
    ...
    template<typename T> void readFromEEPROM(int address, T& xdata);
